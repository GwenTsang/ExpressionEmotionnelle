...
from extract_markers_glozz import build_marker_dataframe
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        default=os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "results", "glozz"),
        help="Dossier de sortie principal (défaut: ../results/glozz/)",
    )
    parser.add_argument(
        "--no-lemma",
        action="store_true",
